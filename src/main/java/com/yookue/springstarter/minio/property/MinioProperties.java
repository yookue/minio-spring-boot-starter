...
package com.yookue.springstarter.minio.property;
...
import com.yookue.springstarter.minio.config.MinioAutoConfiguration;
 ...
 * @author David Hsing
 */
@ConfigurationProperties(prefix = MinioAutoConfiguration.PROPERTIES_PREFIX)
@Getter
@Setter
@ToString
